...
|---|---|---:|---:|:---:|---|
| **ComerGeneralized2024** | 金属**酸化物**表面 × O\* / OH\* | 325 | 23 | なし | [README](ComerGeneralized2024/README_jp.md) |
| **MamunHighT2019** | **二元合金**表面 × 小分子フラグメント（CH\*/O\*/H\* …） | 45,130 | 21\* | なし | [README](MamunHighT2019/README_jp.md) |
| **FG_dataset** | 純**金属**表面 × **官能基を持つ有機分子**（芳香族・アミド等） | 2,651 | 18 | **D3(BJ)** | [README](FG_dataset/README_jp.md) |

...
> インタラクティブ版（plotly）: GitHub のファイル表示では HTML はレンダリングされないため、
> 外部プレビュー経由で開いてください →
> [**ダッシュボードを開く**](https://raw.githack.com/ishikawa-group/mlip-adsorption-energy-benchmark/main/result/ComerGeneralized2024/analysis/ComerGeneralized2024_dashboard.html)。
> ローカルでは `analysis/ComerGeneralized2024_dashboard.html` を直接ブラウザで開けます。
